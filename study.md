...
```md
No. Because you have to make mass_kg an instance variable by referring to it as @mass_kg
```
...
```md
Yes. They refer or point to the same object.
```
...
```md
A hash or an object.  It would not have a class of star.
```
