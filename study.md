...
```md
Yes, because it prints 0170261586578.086
```
...
```md
Mass is missing the @ symbol in front of the define of mass_kg in both instances.
```
...
```md
No, they are completely different variables and are not connected.
```
...
```md
Yes, they are pointing to the same information.
```
