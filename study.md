...
```md
Yes, puts "The star is approximately 40170261586578.086 kilometers away."
```
...
```md
Puts, "The star has a mass of approximately 2.4477e+29 kilograms.", once you at @ before mass_kg
...
```md
No, Star.new initializes a new instance of Star each time it is invoked.
```
...
```md
Yes, they both have the same object_id
```
